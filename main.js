...
function preload(){
  paddle_ball = loadSound("ball_touch_paddel.wav");
  paddle_not_ball = loadSound("missed.wav");
}
...
if(pcscore ==4){
    ...
    text("press Restart the play again",width/2,height/2+30);
    noLoop();
    pcscore = 0;
}
